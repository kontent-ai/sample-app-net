...
namespace DancingGoat.Utils
{
    public class ProjectContext
    {
        ...
        private string GetProjectGuid()
        {
            ...
            var configProjectId = _configuration.GetSection(nameof(DeliveryOptions))[nameof(DeliveryOptions.ProjectId)] ?? _configuration.GetSection(nameof(AppConfiguration)).Get<AppConfiguration>().DefaultDeliveryOptions.ProjectId;
