...
dotnet publish DancingGoat -c Release --runtime win-x86 -o artifacts\win-x86 -p:PublishTrimmed=true -p:PublishReadyToRun=true
7z a ($buildFolder + "\artifacts\kontent-sample-app-net-win-x86.zip") ($buildFolder + "\artifacts\win-x64\*.*") -r
